...
class EducationalGroup(SimpleBaseModel):
    number = models.CharField(
        max_length=100, null=True, blank=True, verbose_name="Номер группы"
    )
...
class Student(SimpleBaseModel):
    ...
    group = models.ForeignKey(
        EducationalGroup, null=True, blank=True, on_delete=models.SET_NULL
    )
...
class Laboratory(SimpleBaseModel):
    ...
    educational = models.ForeignKey(
        Subject, on_delete=models.SET_NULL, null=True, verbose_name="Предмет"
    )
    lecturer = models.ForeignKey(
        Lecturer, on_delete=models.PROTECT, verbose_name="Преподаватель"
    )
...
class Laboratory_Status(SimpleBaseModel):
    ...
    status = models.CharField(
        ...
        null=True,
        blank=True,
        choices=STATUS_ACCEPTANCES_CHOICES,
        default=STATUS_REJECT,
    ...
    additional_status = models.CharField(
        ...
        null=True,
        blank=True,
        choices=STATUS_VIEWEDS_CHOICES,
        default=ADDITIONAL_STATUS_NOT_VIEWED,
    ...
    student_status = models.CharField(
        ...
        null=True,
        blank=True,
        choices=STATUS_GENERATED_CHOICES,
        default=STUDENT_STATUS_NOT_GENERATED,
